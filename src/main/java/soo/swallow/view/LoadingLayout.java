...
import soo.swallow.base.ViewFinder;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        loadingView = ViewFinder.inflate(getContext(), R.layout.loading_layout, null);
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        this.addView(loadingView, params);
        
        loadingContainer = ViewFinder.findViewById(this, R.id.loading_layout_loading);
        errorToastContainer = ViewFinder.findViewById(this, R.id.loading_layout_error);
        loadingTxt = ViewFinder.findViewById(this, R.id.loading_layout_loading_textview);
        errorToastTxt = ViewFinder.findViewById(this, R.id.loading_layout_error_textview);
